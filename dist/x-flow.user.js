...
(function () {
  ...
  class Sandbox {
    ...
    initialize() {
      ...
      const doReplace = () => {
        document.documentElement.innerHTML = '<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"><meta name="referrer" content="no-referrer"><title>X-Flow | 极境流媒体</title></head><body style="margin:0;overflow:hidden;width:100vw;height:100vh;background:#0D0D12;"><div id="xflow-app-root" style="position:fixed;inset:0;z-index:2147483647;background:var(--bg-base);color:var(--text-100);overflow:hidden;"></div></body>';
        this.injectAppCss();
        const fontLinks = document.createElement("div");
        fontLinks.innerHTML = '<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Syne:wght@500;700;800&display=swap" rel="stylesheet">';
